...
/**
 * CLASSE NomenclatureMauvaiseException :<br/>
 * Hérite de AbstractTechnicalException.<br/>
 * Typée pour signaler qu'une nomenclature 
 ...
 *
 */
public class NomenclatureMauvaiseException extends AbstractTechnicalException {
	...
	private static final Log LOG = LogFactory
			.getLog(NomenclatureMauvaiseException.class);
	 ...
	 * Permet de construire une NomenclatureMauvaiseException
	 * sans message ni propagation d'exception cause.<br/>
	 *
	 */
	public NomenclatureMauvaiseException() {
		super();
	} // Fin de NomenclatureMauvaiseException().___________________________
	 ...
	 */
	public NomenclatureMauvaiseException(final String pMessage) {
		super(pMessage);
	} // Fin de CONSTRUCTEUR NomenclatureMauvaiseException(...).___________
	 ...
	 */
	public NomenclatureMauvaiseException(final Throwable pCause) {
		super(pCause);
	} // Fin de CONSTRUCTEUR NomenclatureMauvaiseException(...).___________
...
} // FIn DE LA CLASSE NomenclatureMauvaiseException.-------------------------
