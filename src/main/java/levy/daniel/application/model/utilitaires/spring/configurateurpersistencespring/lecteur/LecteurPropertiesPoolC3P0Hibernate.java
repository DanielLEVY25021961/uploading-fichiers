...
/**
 * CLASSE LecteurPropertiesPoolC3P0Hibernate :<br/>
 * .<br/>
 * <br/>
 *
 ...
 *
 */
public class LecteurPropertiesPoolC3P0Hibernate {

	// ************************ATTRIBUTS************************************/

	/**
	 * "Classe LecteurPropertiesPoolC3P0Hibernate".
	 */
	...
	= LogFactory.getLog(LecteurPropertiesPoolC3P0Hibernate.class);
	 ...
	 */
	public LecteurPropertiesPoolC3P0Hibernate() {		
		this(null);
...
} // FIN DE LA CLASSE LecteurPropertiesPoolC3P0Hibernate.--------------------
