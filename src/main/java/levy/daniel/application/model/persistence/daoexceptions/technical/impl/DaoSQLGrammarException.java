...
/**
 * class DaoSQLGrammarException :<br/>
 * Exception pour les problèmes avec la grammaire SQL 
 * (table mal écrite, ...).<br/>
 * <br/>
 *
 ...
 *
 */
public class DaoSQLGrammarException extends AbstractDaoException {
	...
	private static final Log LOG 
		= LogFactory.getLog(DaoSQLGrammarException.class);

	// *************************METHODES************************************/
	

	/**
	 * method CONSTRUCTEUR DaoSQLGrammarException() :<br/>
	 * CONSTRUCTEUR D'ARITE NULLE.<br/>
	 * Permet de construire une DaoSQLGrammarException
	 * sans message ni propagation d'exception cause.<br/>
	 */
	public DaoSQLGrammarException() {
		super();
	} // Fin de DaoSQLGrammarException().__________________________________
	


	/**
	 * method CONSTRUCTEUR DaoSQLGrammarException(String pMessage) :<br/>
	 ...
	 */
	public DaoSQLGrammarException(final String pMessage) {
		super(pMessage);
	} // Fin de CONSTRUCTEUR DaoSQLGrammarException(
	// String pMessage).___________________________________________________
	
	
	
	/**
	 * method CONSTRUCTEUR DaoSQLGrammarException(Throwable pCause) :<br/>
	 * Constructeur d'arité 1.<br/>
	 * Permet de construire une DaoSQLGrammarException
	 ...
	 */
	public DaoSQLGrammarException(final Throwable pCause) {
		super(pCause);
	} // Fin de CONSTRUCTEUR DaoSQLGrammarException(
	...
	/**
	 * method CONSTRUCTEUR DaoSQLGrammarException(
	 * String pMessage
	 * , Throwable pCause) :<br/>
...
} // FIN DE LA CLASSE DaoSQLGrammarException.--------------------------------
