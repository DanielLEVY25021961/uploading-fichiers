...
/**
 * CLASSE FileSystemUploadTempServiceTest :<br/>
 * Test JUnit de {@link FileSystemUploadTempService}.<br/>
 * <br/>
 *
 ...
 *
 */
public class FileSystemUploadTempServiceTest {
    ...
    /**
     * FileSystemUploadTempService instancié dans la méthode init() 
     * avant chaque test.<br/>
     */
   private transient FileSystemUploadTempService service;
	...
	private static final Log LOG 
		= LogFactory.getLog(FileSystemUploadTempServiceTest.class);
	 ...
	 */
	public FileSystemUploadTempServiceTest() {
		super();
	...
	@SuppressWarnings(UNUSED)
	 ...
	 public void testNommerFichierCibleNonExistant() {
			...
			System.out.println("********** CLASSE FileSystemUploadTempServiceTest - méthode testNommerFichierCibleNonExistant() ********** ");
			}
	 ...
	 public void testUploadFileSourceNull() throws Exception {
			...
			/* AFFICHAGE A LA CONSOLE. */
			if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FileSystemUploadTempServiceTest - méthode testUploadFileSourceNull() ********** ");
			}
	 ...
	 public void testUploadFileSourceVide() throws Exception {
			...
			/* AFFICHAGE A LA CONSOLE. */
			if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FileSystemUploadTempServiceTest - méthode testUploadFileSourceVide() ********** ");
			}
	 ...
	 public void testUploadFileTargetNull() throws Exception {
			...
			/* AFFICHAGE A LA CONSOLE. */
			if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FileSystemUploadTempServiceTest - méthode testUploadFileTargetNull() ********** ");
			}
	 ...
	 public void testUploadFileTargetRepertoire() throws Exception {
			...
			/* AFFICHAGE A LA CONSOLE. */
			if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FileSystemUploadTempServiceTest - méthode testUploadFileTargetRepertoire() ********** ");
			}
	...
	public void testUpload() throws Exception {
		...
		/* AFFICHAGE A LA CONSOLE. */
		if (AFFICHAGE_GENERAL && affichage) {
			System.out.println("********** CLASSE FileSystemUploadTempServiceTest - méthode testUpload() ********** ");
		}

		// VALEURS A TESTER ******************************************************
		final String originalFileName = "test_upload.txt";
		
		final MockMultipartFile foo 
			= new MockMultipartFile("test_upload"
				, originalFileName
				, MediaType.TEXT_PLAIN_VALUE
				, "Ceci est un test d'upload en UTF-8 grâve bêèéle".getBytes(StandardCharsets.UTF_8));

		final File fileTarget = new File("temp/testUpload.txt");
		// VALEURS A TESTER ******************************************************
